...
public class DayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewDate = (TextView) view.findViewById(R.id.daytab_selectDate);
        tv_totaltime = (TextView)view.findViewById(R.id.day_totaltime);

        nextday = (Button) view.findViewById(R.id.daytab_nextday);
        previousday = (Button) view.findViewById(R.id.daytab_previousday);

        listView = (ListView)view.findViewById(R.id.daytab_listview);
